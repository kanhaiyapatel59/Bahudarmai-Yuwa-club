...
const seedData = async () => {
  try {
    await mongoose.connect(process.env.MONGO_URI || 'mongodb://127.0.0.1:27017/byc_db');
    console.log('Connected to MongoDB for seeding BYC official committee...');
    ...
    const approvedMember = await Member.create({
      ...
      emergencyContact: { name: 'Hari Shrestha', phone: '+977 9811111111', relation: 'Father' },
      status: 'approved',
      idCardIssued: true,
      approvedAt: new Date(),
    });
    ...
    const officialLeaders = [
      {
        ...
        shortBio: { en: 'Club President leading BYC youth activities in Pipra, Parsa.', ne: 'बहुदरमाई युवा क्लब अध्यक्ष, पिपरा (पर्सा)।' },
      },
      {
        name: { en: 'Pooja Yadav', ne: 'पूजा यादव' },
        position: { en: 'Vice President', ne: 'उपाध्यक्ष' },
        roleCategory: 'executive',
        order: 2,
        phone: '9767721133',
        photo: '/byc_committee_banner.jpg',
        shortBio: { en: 'Vice President driving youth & women empowerment initiatives.', ne: 'बहुदरमाई युवा क्लब उपाध्यक्ष।' },
      },
      {
        name: { en: 'Rajan Patel', ne: 'राजन पटेल' },
        position: { en: 'Secretary', ne: 'सचिव' },
        roleCategory: 'executive',
        order: 3,
        phone: '9767721133',
        photo: '/byc_committee_banner.jpg',
        shortBio: { en: 'Club Secretary overseeing administration & public relations.', ne: 'बहुदरमाई युवा क्लब सचिव।' },
      },
      {
        name: { en: 'Aman Patel', ne: 'अमन पटेल' },
        position: { en: 'Joint Secretary', ne: 'सह-सचिव' },
        roleCategory: 'executive',
        order: 4,
        phone: '9767721133',
        photo: '/byc_committee_banner.jpg',
        shortBio: { en: 'Joint Secretary coordinating committee events.', ne: 'बहुदरमाई युवा क्लब सह-सचिव।' },
      },
      {
        name: { en: 'Arjun Gupta', ne: 'अर्जुन गुप्ता' },
        position: { en: 'Treasurer', ne: 'कोषाध्यक्ष' },
        roleCategory: 'executive',
        order: 5,
        phone: '9767721133',
        photo: '/byc_committee_banner.jpg',
        shortBio: { en: 'Club Treasurer managing financial transparency & donations.', ne: 'बहुदरमाई युवा क्लब कोषाध्यक्ष।' },
      },
      {
        name: { en: 'Baliram Patel', ne: 'बलिराम पटेल' },
        position: { en: 'Coordinator', ne: 'संयोजक' },
        roleCategory: 'coordinator',
        order: 6,
        phone: '9767721133',
        photo: '/byc_committee_banner.jpg',
        shortBio: { en: 'Event Coordinator supervising field activities.', ne: 'बहुदरमाई युवा क्लब संयोजक।' },
      },
      // Executive Members
    ...
    for (const leader of officialLeaders) {
      await Leadership.create(leader);
    }
    console.log(`Created ${officialLeaders.length} official leadership members.`);

    // 4. Create Recent Events with high quality images for Homepage Background
    const recentEvent1 = await Event.create({
      slug: 'historic-shree-bahudarmai-5-day-mela-2026',
      title: {
        en: 'Historic & Mythological 5-Day Shree Bahudarmai Mela 2026',
        ne: 'ऐतिहासिक एवम् पौराणिक ५ दिवसीय श्री बहुदरमाई मेला २०८०/२०८२',
      },
      description: {
        en: 'Grand 5-day cultural & mythological mela organized by Bahudarmai Yuwa Club in Pipra (Parsa) welcoming thousands of devotees.',
        ne: 'बहुदरमाई युवा क्लब, पिपरा (पर्सा) द्वारा आयोजित ५ दिवसीय ऐतिहासिक एवम् पौराणिक श्री बहुदरमाई मेला।',
      },
      category: 'culture',
      ...
      location: {
        en: 'Bahudarmai Municipality-02, Pipra (Parsa)',
        ne: 'बहुदरमाई न.पा.-२, पिपरा (पर्सा)',
      },
      organizer: {
        en: 'Bahudarmai Yuwa Club Committee',
        ne: 'बहुदरमाई युवा क्लब समिति',
      },
      status: 'upcoming',
    ...
    await Event.create({
      ...
      title: {
        en: 'BYC Annual Youth Football Cup 2026',
        ne: 'बहुदरमाई युवा क्लब वार्षिक फुटबल प्रतियोगिता २०२६',
      },
      description: {
        en: 'Inter-ward championship empowering young sports talent with trophy prizes and scout matches.',
        ne: 'वडास्तरीय युवा फुटबल प्रतियोगिता, ट्रफी पुरस्कार तथा खेलकुद प्रतिभा प्रवर्द्धन।',
      },
      category: 'sports',
      ...
      location: {
        en: 'Bahudarmai Pipra School Ground, Ward 2',
        ne: 'बहुदरमाई पिपरा खेल मैदान, वडा नं. २',
      },
      organizer: {
        en: 'BYC Sports Department',
        ne: 'बहुदरमाई युवा क्लब खेलकुद विभाग',
      },
      status: 'upcoming',
      isRegistrationRequired: true,
      maxParticipants: 16,
    ...
    await NewsNotice.create({
      ...
      title: {
        en: 'Hearty Welcome to All Devotees at Shree Bahudarmai Mela',
        ne: 'ऐतिहासिक एवम् पौराणिक ५ दिवसीय श्री बहुदरमाई मेला मा पाल्नुहुने सम्पूर्ण श्रद्धालु भक्तजनहरूलाई हार्दिक स्वागत गर्दछौं।',
      },
      content: {
        en: 'Bahudarmai Yuwa Club Pipra (Parsa) extends a warm welcome to all devotees participating in the historic 5-day Shree Bahudarmai Mela.',
        ne: 'बहुदरमाई युवा क्लब पिपरा (पर्सा) द्वारा आयोजित ५ दिवसीय ऐतिहासिक एवम् पौराणिक मेलामा सम्पूर्ण महानुभावहरूलाई हार्दिक स्वागत गर्दछौं।',
      },
    ...
    await SiteSettings.create({
      ...
      stats: { youthMembers: 520, communityEvents: 54, socialInitiatives: 28, peopleReached: 1250 },
      presidentMessage: {
        name: { en: 'Dhananjay Patel', ne: 'धनञ्जय पटेल' },
        title: { en: 'President, Bahudarmai Yuwa Club', ne: 'अध्यक्ष, बहुदरमाई युवा क्लब' },
        message: {
          en: 'Bahudarmai Yuwa Club stands firmly for unity, progress, youth leadership, and unselfish service across Pipra and Bahudarmai Municipality.',
          ne: 'बहुदरमाई युवा क्लब पिपरा (पर्सा) युवा सशक्तिकरण, समाजसेवा, खेलकुद तथा सांस्कृतिक जगेर्नाका लागि निरन्तर समर्पित छ।',
        },
        photo: '/byc_committee_banner.jpg',
      },
      contactInfo: {
        ...
        mapEmbedUrl: 'https://maps.google.com/?q=Pipra+Bahudarmai+Parsa+Nepal',
      },
      socialLinks: {
    ...
    console.log('Seed completed successfully with real committee members & phone 9767721133!');
    process.exit(0);
  } catch (error) {
